  ...
  return (
    <div className=" gallery max-w-7xl columns-1 sm:columns-2 md:columns-4 lg:columns-5 gap-5 mt-14">
      <Card imageSource={"./images/1.jpg"}>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum vitae iste
        repudiandae asperiores dicta iusto consequuntur animi,
      </Card>
      ...
      <Card imageSource={"./images/12.jpg"}>
        ...
        voluptatibus nihil eos ratione quis mollitia! Sit.
      </Card>
      <Card imageSource={"./images/13.jpg"}>
        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Commodi ipsum,
        maiores eos consectetur ab debitis ratione quaerat facere.
      </Card>
      <Card imageSource={"./images/14.jpg"}>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit
        distinctio maxime ea, reiciendis, deserunt fuga, expedita voluptas atque
        iure ipsum ut vitae!
      </Card>
      ...
      <Card imageSource={"./images/16.jpg"}>
        ...
        corrupti doloribus voluptatum eligendi obcaecati odio numquam. Similique
        porro voluptatem veniam.
      </Card>
      ...
      <Card imageSource={"./images/19.jpg"}>
        ...
        et totam. Maiores, veritatis voluptatum?
      </Card>
      ...
      <Card imageSource={"./images/26.jpg"}>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut ab error
        perspiciatis ipsum, quae eos.
      </Card>
      <Card imageSource={"./images/27.jpg"}>
        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Explicabo
        ullam corporis ipsum harum animi architecto, id, quia dolorem quae
        impedit sunt? Sunt ipsum dolores neque magni voluptatibus error
        explicabo a?
      </Card>
    </div>
  );
